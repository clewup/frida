...
const Hero = () => {
    return (
            <div className="h-screen-header bg-theme-mint flex relative overflow-hidden rounded-md">
                <div className="w-1/2 relative bg-[#eeeeee]">
                    <Image src="/images/chair.png" alt="product" fill={true} className="w-full object-contain p-20"/>
                </div>

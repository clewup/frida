-- CreateEnum
CREATE TYPE "OrderStatus" AS ENUM ('Pending', 'Processing', 'Shipped', 'Delivered', 'Cancelled', 'Refunded', 'Returned', 'Complete');

-- CreateEnum
CREATE TYPE "Colour" AS ENUM ('White', 'Black', 'Gray', 'Red', 'Blue', 'Green', 'Yellow', 'Orange', 'Purple', 'Pink', 'Brown', 'NA');
...
CREATE TABLE "Product" (
    ...
    "colour" "Colour" NOT NULL DEFAULT 'NA',
...
-- AddForeignKey
ALTER TABLE "CartItem" ADD CONSTRAINT "CartItem_createdById_fkey" FOREIGN KEY ("createdById") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
